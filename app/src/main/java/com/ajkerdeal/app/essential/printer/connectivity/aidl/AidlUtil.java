...
import com.ajkerdeal.app.essential.printer.connectivity.utils.TableItem;
...
public class AidlUtil {
    ...
    private final String TAG = "AidlUtil";
     ...
     * 7 -- CODE93,
     * 8 -- CODE128
     * @param height: barcode height, values 1 to 255, default 162
    ...
    public void printText(String content, String typeface, float size, boolean isBold, boolean isUnderLine, int lineGap) {
        ...
        try {
            ...
            woyouService.printTextWithFont(content, typeface, size, null);
            woyouService.lineWrap(lineGap, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    public void printText(String content, String typeface, float size, int lineGap){
        ...
        try {
            woyouService.printTextWithFont(content, typeface, size, printerCallback());
            woyouService.lineWrap(lineGap, null);
        }catch (RemoteException e){
            e.printStackTrace();
        }
    ...
    public ICallback printerCallback(){
        return new ICallback.Stub(){
     ...
     * 0, the same printBitmap
     * 1, the threshold of 200 black and white pictures
