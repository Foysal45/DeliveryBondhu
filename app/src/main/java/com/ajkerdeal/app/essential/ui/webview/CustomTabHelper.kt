...
class CustomTabHelper {
    ...
    fun getPackageNameToUse(context: Context, url: String = "https://www.ajkerdeal.com"): String? {
        ...
        defaultViewHandlerInfo?.let {
            ...
            Timber.d("CustomTabHelper defaultViewHandlerPackageName $defaultViewHandlerPackageName")
        }

        val resolvedActivityList = pm.queryIntentActivities(activityIntent, 0)
        Timber.d("CustomTabHelper resolvedActivityList $resolvedActivityList")
        ...
        Timber.d("CustomTabHelper packagesSupportingCustomTabs $packagesSupportingCustomTabs")
