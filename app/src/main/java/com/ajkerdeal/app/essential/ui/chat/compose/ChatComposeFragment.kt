...
import com.ajkerdeal.app.essential.api.models.chat.ChatData
import com.ajkerdeal.app.essential.api.models.chat.ChatUserData
import com.ajkerdeal.app.essential.api.models.chat.HistoryData
import com.ajkerdeal.app.essential.api.models.fcm.FCMDataModel
import com.ajkerdeal.app.essential.api.models.fcm.FCMNotification
import com.ajkerdeal.app.essential.api.models.fcm.FCMRequest
import com.ajkerdeal.app.essential.databinding.FragmentChatComposeBinding
import com.ajkerdeal.app.essential.ui.chat.ChatActivity
import com.ajkerdeal.app.essential.utils.FileUtils
    ...
    private fun generateChatMessage(type: Int) {
        ...
        when (type) {
            ...
            2 -> {
                ...
                val uri = FileProvider.getUriForFile(requireContext(), "com.ajkerdeal.app.essential.fileprovider", File(filePath))
